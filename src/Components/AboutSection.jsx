...
const AboutText = () => (
  <div className="w-full px-4 lg:w-1/2">
    <div className="mb-12 max-w-[540px] lg:mb-0">
      ...
      <a href="" className="inline-flex items-center justify-center rounded-md border border-primary bg-primary px-7 py-3 text-center text-base font-medium text-white hover:border-blue-dark hover:bg-blue-dark">
        Know More
      </a>
    </div>
  </div>
...
const ImageBlock = ({ src, alt, className }) => (
  <div className={`w-full px-2 sm:w-1/2 sm:px-4 lg:px-2 xl:px-4 ${className}`}>

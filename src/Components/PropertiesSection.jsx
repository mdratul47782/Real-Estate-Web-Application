const Property = ({ image, title, price, bedrooms, bathrooms }) => {
  return (
...
const PropertiesSection = () => {
  const properties = [
    ...
    {
      image:
        "https://img.freepik.com/premium-photo/modern-luxury-villa_897093-1042.jpg?w=900",
      title: "Modern luxury villa",
      price: 3500,
      bedrooms: 5,
      bathrooms: 4,
    ...
    {
      image:
        "https://static.vecteezy.com/system/resources/previews/041/913/158/non_2x/ai-generated-a-dilapidated-shelter-highlighting-the-lack-of-adequate-housing-generative-ai-photo.jpeg",
      title: "Modern luxury villa",
      price: 35000,
      bedrooms: 15,
      bathrooms: 11,
    ...
    {
      image:
        "https://pmedia.launchgood.com/115823/help_build_homes_for_a_poor_family_in_bangladesh_image%20home%20bd-700x525.jpg",
      title: "Modern luxury villa",
      price: 35000,
      bedrooms: 15,
      bathrooms: 11,
